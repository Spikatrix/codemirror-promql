...
exports.snippets = [
    {
        ...
        apply: (0, autocomplete_1.snippet)('sum(rate(${__input_vector__}[5m]))'),
    },
    {
        ...
        apply: (0, autocomplete_1.snippet)('histogram_quantile(${__quantile__}, sum by(le) (rate(${__histogram_metric__}[5m])))'),
    },
    {
        ...
        apply: (0, autocomplete_1.snippet)('label_replace(${__input_vector__}, "${__dst__}", "${__replacement__}", "${__src__}", "${__regex__}")'),
    },
    {
        ...
        detail: 'snippet',
        info: 'Largest k elements by sample value',
        apply: (0, autocomplete_1.snippet)('topk(${__rank_number__}, ${__input_vector__})'),
    },
    {
        ...
        detail: 'snippet',
        info: 'Smallest k elements by sample value',
        apply: (0, autocomplete_1.snippet)('bottomk(${__rank_number__}, ${__input_vector__})'),
    },
    {
        ...
        apply: (0, autocomplete_1.snippet)('count_values("${__label_name__}", ${__metric__})'),
    },
];
