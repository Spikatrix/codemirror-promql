...
function getMetricNameInVectorSelector(tree, state) {
    ...
    var currentNode = (0, parser_1.walkBackward)(tree, parser_terms_1.VectorSelector);
    if (!currentNode) {
        // Weird case that shouldn't happen, because "VectorSelector" is by definition the parent of the LabelMatchers.
        return '';
    }
    currentNode = (0, parser_1.walkThrough)(currentNode, parser_terms_1.MetricIdentifier, parser_terms_1.Identifier);
    if (!currentNode) {
        return '';
    }
...
function computeStartCompletePosition(node, pos) {
    ...
    var start = node.from;
    if (node.type.id === parser_terms_1.LabelMatchers || node.type.id === parser_terms_1.GroupingLabels) {
        start = computeStartCompleteLabelPositionInLabelMatcherOrInGroupingLabel(node, pos);
    }
    else if (node.type.id === parser_terms_1.FunctionCallBody || (node.type.id === parser_terms_1.StringLiteral && ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type.id) === parser_terms_1.LabelMatcher)) {
    ...
    else if (node.type.id === parser_terms_1.OffsetExpr ||
        (node.type.id === parser_terms_1.NumberLiteral && ((_b = node.parent) === null || _b === void 0 ? void 0 : _b.type.id) === 0 && ((_c = node.parent.parent) === null || _c === void 0 ? void 0 : _c.type.id) === parser_terms_1.SubqueryExpr) ||
        (node.type.id === 0 &&
            (((_d = node.parent) === null || _d === void 0 ? void 0 : _d.type.id) === parser_terms_1.OffsetExpr ||
                ((_e = node.parent) === null || _e === void 0 ? void 0 : _e.type.id) === parser_terms_1.MatrixSelector ||
                (((_f = node.parent) === null || _f === void 0 ? void 0 : _f.type.id) === parser_terms_1.SubqueryExpr && (0, parser_1.containsAtLeastOneChild)(node.parent, parser_terms_1.Duration))))) {
        start = pos;
    }
    return start;
}
...
function analyzeCompletion(state, node) {
    ...
    switch (node.type.id) {
        case 0: // 0 is the id of the error node
            if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type.id) === parser_terms_1.OffsetExpr) {
            ...
            if (((_b = node.parent) === null || _b === void 0 ? void 0 : _b.type.id) === parser_terms_1.LabelMatcher) {
            ...
            if (((_c = node.parent) === null || _c === void 0 ? void 0 : _c.type.id) === parser_terms_1.MatrixSelector) {
                // we are likely in the given situation:
                // `metric_name{}[5]`
            ...
            if (((_d = node.parent) === null || _d === void 0 ? void 0 : _d.type.id) === parser_terms_1.SubqueryExpr && (0, parser_1.containsAtLeastOneChild)(node.parent, parser_terms_1.Duration)) {
                // we are likely in the given situation:
                //    `rate(foo[5d:5])`
            ...
            break;
        case parser_terms_1.Identifier:
            ...
            if (((_e = node.parent) === null || _e === void 0 ? void 0 : _e.type.id) === 0) {
                ...
                if ((errorNodeParent === null || errorNodeParent === void 0 ? void 0 : errorNodeParent.type.id) === parser_terms_1.StepInvariantExpr) {
                    // we are likely in the given situation:
                    //   `expr @ s`
                ...
                if ((errorNodeParent === null || errorNodeParent === void 0 ? void 0 : errorNodeParent.type.id) === parser_terms_1.AggregateExpr) {
                ...
                if ((errorNodeParent === null || errorNodeParent === void 0 ? void 0 : errorNodeParent.type.id) === parser_terms_1.VectorSelector) {
                ...
                if (errorNodeParent && (0, parser_1.containsChild)(errorNodeParent, parser_terms_1.Expr)) {
            ...
            var parent_1 = (_h = (_g = (_f = node.parent) === null || _f === void 0 ? void 0 : _f.parent) === null || _g === void 0 ? void 0 : _g.parent) === null || _h === void 0 ? void 0 : _h.parent;
            if (!parent_1) {
            ...
            var containExprTwice = (0, parser_1.containsChild)(parent_1, parser_terms_1.Expr, parser_terms_1.Expr);
            if (containExprTwice) {
                if (parent_1.type.id === parser_terms_1.BinaryExpr && !(0, parser_1.containsAtLeastOneChild)(parent_1, 0)) {
                    ...
                    if ((0, parser_1.containsAtLeastOneChild)(parent_1, parser_terms_1.Eql, parser_terms_1.Gte, parser_terms_1.Gtr, parser_terms_1.Lte, parser_terms_1.Lss, parser_terms_1.Neq) && !(0, parser_1.walkThrough)(parent_1, parser_terms_1.BinModifiers, parser_terms_1.Bool)) {
                ...
                if (parent_1.type.id !== parser_terms_1.FunctionCallArgs && parent_1.type.id !== parser_terms_1.MatrixSelector) {
        ...
        case parser_terms_1.LabelName:
            if (((_j = node.parent) === null || _j === void 0 ? void 0 : _j.type.id) === parser_terms_1.GroupingLabel) {
                // In this case we are in the given situation:
                //      sum by (myL)
                // So we have to continue to autocomplete any kind of labelName
                result.push({ kind: ContextKind.LabelName });
            }
            else if (((_k = node.parent) === null || _k === void 0 ? void 0 : _k.type.id) === parser_terms_1.LabelMatcher) {
                // In that case we are in the given situation:
        ...
        case parser_terms_1.StringLiteral:
            if (((_l = node.parent) === null || _l === void 0 ? void 0 : _l.type.id) === parser_terms_1.LabelMatcher) {
                // In this case we are in the given situation:
                //      metric_name{labelName=""}
                ...
                var labelName = '';
                if (((_m = node.parent.firstChild) === null || _m === void 0 ? void 0 : _m.type.id) === parser_terms_1.LabelName) {
                ...
                var labelMatchers = (0, parser_1.buildLabelMatchers)((0, parser_1.retrieveAllRecursiveNodes)((0, parser_1.walkBackward)(node, parser_terms_1.LabelMatchList), parser_terms_1.LabelMatchList, parser_terms_1.LabelMatcher), state);
                result.push({
        ...
        case parser_terms_1.NumberLiteral:
            if (((_o = node.parent) === null || _o === void 0 ? void 0 : _o.type.id) === 0 && ((_p = node.parent.parent) === null || _p === void 0 ? void 0 : _p.type.id) === parser_terms_1.SubqueryExpr) {
            ...
            break;
        case parser_terms_1.Duration:
        case parser_terms_1.OffsetExpr:
            result.push({ kind: ContextKind.Duration });
            break;
        case parser_terms_1.FunctionCallBody:
            // In this case we are in the given situation:
            //       sum() or in rate()
        ...
        case parser_terms_1.Neq:
            if (((_q = node.parent) === null || _q === void 0 ? void 0 : _q.type.id) === parser_terms_1.MatchOp) {
                result.push({ kind: ContextKind.MatchOp });
            }
            else if (((_r = node.parent) === null || _r === void 0 ? void 0 : _r.type.id) === parser_terms_1.BinaryExpr) {
                result.push({ kind: ContextKind.BinOp });
            }
            break;
        ...
        case parser_terms_1.MatchOp:
            result.push({ kind: ContextKind.MatchOp });
            break;
        case parser_terms_1.Pow:
        case parser_terms_1.Mul:
        case parser_terms_1.Div:
        case parser_terms_1.Mod:
        case parser_terms_1.Add:
        case parser_terms_1.Sub:
        case parser_terms_1.Eql:
        case parser_terms_1.Gte:
        case parser_terms_1.Gtr:
        case parser_terms_1.Lte:
        case parser_terms_1.Lss:
        case parser_terms_1.And:
        case parser_terms_1.Unless:
        case parser_terms_1.Or:
